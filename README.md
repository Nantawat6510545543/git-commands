...
1. When using Git locally, what are these?  Define each one in a sentence
    ...
    * Working copy: Your local project's active files.
    * master: Main branch (often called "main" now).
    * HEAD: Points to the latest commit you're on.
...
3. There are 2 ways to create a local Git repository.  Briefly descibe each one:
   - Initialize: `git init` to start a new repo from scratch.
   - Clone: `git clone` to copy an existing remote repo.
